...
public class ApplicationConfigValueResolverTest {

    private ApplicationConfigValueResolver configValueResolver;

    @Before
    public void setUp() {
        configValueResolver = new ApplicationConfigValueResolver();
    }
    ...
    public void resolveWithExceptions() {
        ...
        TestData[] testData = new TestData[] {
                ...
                new TestData("value of ${k1}",
                        ...
                        "Circular dependency found while evaluating ${k1} -> %s",
                        ImmutableSet.of("k1", "k2")),
                new TestData("value of ${k2}",
                        ImmutableMap.of("k1", "${k2}", "k2", "${k1}"),
                        IllegalStateException.class,
                        "Circular dependency found while evaluating ${k2} -> %s",
