...
@Api(
        value = "Agent storage API based on file's path. This API requires an authenticated subject.",
        authorizations = {
...
public class PathBasedAgentStorageAuthenticatedResource {

    private static final Logger LOG = LoggerFactory.getLogger(PathBasedAgentStorageAuthenticatedResource.class);
